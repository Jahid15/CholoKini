...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2024 at 03:16 PM
...
(27, 'shariar ferdous', 'sf@gmail.com', 'admin123', '', '', '', '', '', '0123456789', '', 'Active'),
(28, 'Khan Israk Ahmed', 'kahmed221275@gmail.com', '0987654321', '', '', '', '', '', '01516183490', '', 'Active');
...
--
ALTER TABLE `billing`
  MODIFY `billing_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1358;
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
