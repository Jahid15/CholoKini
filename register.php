...
<script>
	function validatecustomer() {
		...
		var mobileExp = /^[0-9]{11}$/; // Regular expression for exactly 11 digis
		...
		if (!mobileNo.match(mobileExp)) { // Check if the mobile number is exactly 11 digits
			document.getElementById("errmobile_no").innerHTML = "Mobile number must be exactly 11 digits.";
			errchk = "True";
		}
