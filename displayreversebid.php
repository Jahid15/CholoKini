...
<div class="img-wrap">
	<center>
		<a href="singlereversebid.php?productid=<?php echo $rsproduct[0]; ?>"><img src="<?php echo $imgname; ?>" alt=" " class="img-responsive"style="height: 250px;" /></a>
	</center>
</div>
<figcaption class="info-wrap">
<h4 class="title"><a href="singlereversebid.php?productid=<?php echo $rsproduct[0]; ?>"><?php echo $rsproduct['product_name']; ?></a></h4>
...
<div class="bottom-wrap">
		<a href="singlereversebid.php?productid=<?php echo $rsproduct[product_id]; ?>" class="btn btn-sm btn-primary float-right">Click to Bid</a>	
