					...
					<div class="col-xl-7 col-lg-6 col-md-7 col-sm-12">
						...
						<div class="quick-view-content">
							<div class="product-info">
								...
								<p>
								<h4>Time Remaining<p id="demo<?php $rsproduct['product_id']; ?>" style="color: red;"></p>
								</h4>
								<script>
										...
										<div class="col-md-8">
											<table class="table table-striped table-bordered">
												<tbody>
													<tr>
														<th>Uploaded by :</th>
														<td><?php echo $rsproduct['customer_name']; ?></td>
													</tr>
													<tr>
														<th>Product Code :</th>
													...
													<tr>
														...
														<td><?php echo $rsproduct['product_warranty']; ?></td>
													</tr>
													<tr>
														<th>Company :</th>
														<td><?php echo $rsproduct['company_name']; ?></td>
													</tr>
												</tbody>
											</table>
										</div>
							...
							<div id="review" class="tab-pane fade">
								...
								<div class="description-content">
									<p>
										...
										$sqleditbidding = "
        SELECT customer.customer_name, bidding.bidding_amount, bidding.bidding_date_time
        FROM bidding
        LEFT JOIN customer ON bidding.customer_id = customer.customer_id
        WHERE product_id='$_GET[productid]'
        AND bidding_id = (
            SELECT MAX(bid.bidding_id)
            FROM bidding AS bid
            WHERE bid.customer_id = bidding.customer_id
              AND bid.product_id = '$_GET[productid]'
        )
        ORDER BY bidding.bidding_id DESC";
...
*/
								...
								<script type="application/javascript">
									countdowntimer('<?php echo $rsproduct[0] . $i; ?>', '<?php echo date("M d, Y H:i:s", strtotime($rsproduct['end_date_time'])); ?>');
								</script>
